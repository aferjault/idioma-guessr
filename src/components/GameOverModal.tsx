      ...
      >
        ...
        <div className="bg-muted rounded-xl p-5 space-y-3 text-left">
          <div className="flex items-center gap-3">
            <FlagIcon languageCode={phrase.languageCode} className="text-4xl" />
            <div>
              <p className="text-xs text-muted-foreground uppercase tracking-wider font-semibold">
                La langue était
              </p>
              <p className="text-xl font-bold text-foreground">{phrase.language}</p>
            </div>
          </div>
          <div className="border-t border-border pt-3 space-y-3">
            ...
            <div className="bg-background/50 rounded-lg px-3 py-2.5">
              <p className="text-xs text-muted-foreground mb-1 font-medium">Traduction française :</p>
